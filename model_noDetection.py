...
def build_EfficientPose(phi,
    ...
    #build subnets
    rotation_net, translation_net = build_subnets(num_classes,
                                                subnet_width,
                                                subnet_depth,
    ...
    rotation, translation, transformation = apply_subnets_to_feature_maps(rotation_net,
                                                                                  translation_net,
                                                                                  fpn_feature_maps,
                                                                                  image_input,
    ...
    efficientpose_train = models.Model(inputs = [image_input, camera_parameters_input], outputs = [transformation], name = 'efficientpose')
    ...
    if print_architecture:
        print_models(efficientpose_train, rotation_net, translation_net)
    ...
    all_layers = list(set(efficientpose_train.layers + rotation_net.layers + translation_net.layers))
...
def build_subnets(num_classes, subnet_width, subnet_depth, subnet_num_iteration_steps, num_groups_gn, num_rotation_parameters, freeze_bn, num_anchors):
    ...
    return rotation_net, translation_net     
...
def apply_subnets_to_feature_maps(rotation_net, translation_net, fpn_feature_maps, image_input, camera_parameters_input, input_size, anchor_parameters):
    """
    Applies the subnetworks to the BiFPN feature maps
    Args:
        rotation_net, translation_net: Subnetworks
    ...
    return rotation, translation, transformation
